    ...
    <div className="card">
        <div className="card-body">
            <div className="d-flex flex-column align-items-center text-center">
                <img src={`https://bootdey.com/img/Content/avatar/avatar${id}.png`} alt="Admin" className="rounded-circle p-1 bg-primary" width="110" />
                <div className="mt-3">
                    <h4>{`${student.data.firstName} ${student.data.lastName}`}</h4>
                    <p className="text-secondary mb-1">Full Stack Developer</p>
                    <p className="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
                    <LinkButton title="Close" divStyle="" LinkStyle="" to ="/"/>
                </div>
            </div>
            <hr className="my-4" />
...
export default SocialNetworkStudent;